      SUBROUTINE AR_SLAHQR( WANTT, WANTZ, N, ILO, IHI, H, LDH, WR, WI,
...
*  =======
*
*  AR_SLAHQR is an auxiliary routine called by SHSEQR to update the
...
*          ILO = 1). AR_SLAHQR works primarily with the Hessenberg
...
*  INFO    (output) INTEGER
*          = 0: successful exit
*          > 0: AR_SLAHQR failed to compute all the eigenvalues ILO to IHI
