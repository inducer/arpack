...
*     .. External Functions ..
      ...
      EXTERNAL           AR_LSAME, IZAMAX, AR_DLAMCH, DZASUM
*     ..
*     .. External Subroutines ..
      EXTERNAL           AR_DLABAD, AR_XERBLA, ZCOPY, ZDSCAL, ZGEMV, AR_ZLATRS
*     ..
*     .. Intrinsic Functions ..
...
*
            IF( KI.GT.1 ) THEN
               CALL AR_ZLATRS( 'Upper', 'No transpose', 'Non-unit', 'Y',
...
*
            IF( KI.LT.N ) THEN
               CALL AR_ZLATRS( 'Upper', 'Conjugate transpose', 'Non-unit',
