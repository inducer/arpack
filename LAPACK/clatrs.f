      SUBROUTINE AR_CLATRS( UPLO, TRANS, DIAG, NORMIN, N, A, LDA, X, SCALE,
     $                   CNORM, INFO )
*
...
*  =======
*
*  AR_CLATRS solves one of the triangular systems
*
...
*     .. External Functions ..
      ...
      REAL               SCASUM, AR_SLAMCH
      COMPLEX            CDOTC, CDOTU, AR_CLADIV
      EXTERNAL           AR_LSAME, ICAMAX, ISAMAX, SCASUM, AR_SLAMCH, CDOTC,
     $                   CDOTU, AR_CLADIV
*     ..
*     .. External Subroutines ..
      EXTERNAL           CAXPY, CSSCAL, CTRSV, AR_SLABAD, SSCAL, AR_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      SMLNUM = AR_SLAMCH( 'Safe minimum' )
      BIGNUM = ONE / SMLNUM
      CALL AR_SLABAD( SMLNUM, BIGNUM )
      SMLNUM = SMLNUM / AR_SLAMCH( 'Precision' )
      BIGNUM = ONE / SMLNUM
      SCALE = ONE
*
