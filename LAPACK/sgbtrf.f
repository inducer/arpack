      SUBROUTINE AR_SGBTRF( M, N, KL, KU, AB, LDAB, IPIV, INFO )
*
...
*  =======
*
*  AR_SGBTRF computes an LU factorization of a real m-by-n band matrix A
...
*     ..
*     .. External Functions ..
      INTEGER            AR_ILAENV, ISAMAX
      EXTERNAL           AR_ILAENV, ISAMAX
*     ..
*     .. External Subroutines ..
      EXTERNAL           SCOPY, AR_SGBTF2, SGEMM, SGER, AR_SLASWP, SSCAL,
     $                   SSWAP, STRSM, AR_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      NB = AR_ILAENV( 1, 'AR_SGBTRF', ' ', M, N, KL, KU )
*
...
*        Use unblocked code
*
         CALL AR_SGBTF2( M, N, KL, KU, AB, LDAB, IPIV, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               ...
               J3 = MAX( 0, JU-J-KV+1 )
*
*              Use AR_SLASWP to apply the row interchanges to A12, A22, and
*              A32.
*
               CALL AR_SLASWP( J2, AB( KV+1-JB, J+JB ), LDAB-1, 1, JB,
     $                      IPIV( J ), 1 )
*
