      SUBROUTINE AR_ZGBTRF( M, N, KL, KU, AB, LDAB, IPIV, INFO )
*
...
*  =======
*
*  AR_ZGBTRF computes an LU factorization of a complex m-by-n band matrix A
...
*     ..
*     .. External Functions ..
      INTEGER            AR_ILAENV, IZAMAX
      EXTERNAL           AR_ILAENV, IZAMAX
*     ..
*     .. External Subroutines ..
      EXTERNAL           AR_XERBLA, ZCOPY, AR_ZGBTF2, ZGEMM, ZGERU, AR_ZLASWP,
     $                   ZSCAL, ZSWAP, ZTRSM
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
...
*
      NB = AR_ILAENV( 1, 'AR_ZGBTRF', ' ', M, N, KL, KU )
*
...
*        Use unblocked code
*
         CALL AR_ZGBTF2( M, N, KL, KU, AB, LDAB, IPIV, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               ...
               J3 = MAX( 0, JU-J-KV+1 )
*
*              Use AR_ZLASWP to apply the row interchanges to A12, A22, and
*              A32.
*
               CALL AR_ZLASWP( J2, AB( KV+1-JB, J+JB ), LDAB-1, 1, JB,
     $                      IPIV( J ), 1 )
*
