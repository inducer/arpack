...
*     .. External Functions ..
      ...
      INTEGER            ISAMAX
      REAL               SDOT, AR_SLAMCH
      EXTERNAL           AR_LSAME, ISAMAX, SDOT, AR_SLAMCH
*     ..
*     .. External Subroutines ..
      EXTERNAL           SAXPY, SCOPY, SGEMV, AR_SLABAD, AR_SLALN2, SSCAL,
     $                   AR_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
                     CALL AR_SLALN2( .FALSE., 1, 1, SMIN, ONE, T( J, J ),
...
*
                     CALL AR_SLALN2( .FALSE., 2, 1, SMIN, ONE,
...
*                    1-by-1 diagonal block
*
                     CALL AR_SLALN2( .FALSE., 1, 2, SMIN, ONE, T( J, J ),
...
*                    2-by-2 diagonal block
*
                     CALL AR_SLALN2( .FALSE., 2, 2, SMIN, ONE,
     $                            T( J-1, J-1 ), LDT, ONE, ONE,
...
*
                     CALL AR_SLALN2( .TRUE., 2, 1, SMIN, ONE, T( J, J ),
     $                            LDT, ONE, ONE, WORK( J+N ), N, WR,
     $                            ZERO, X, 2, SCALE, XNORM, IERR )
*
*                    Scale if necessary
...
*                      ([T(j+1,j) T(j+1,j+1)]             )
*
                     CALL AR_SLALN2( .TRUE., 2, 2, SMIN, ONE, T( J, J ),
     $                            LDT, ONE, ONE, WORK( J+N ), N, WR,
     $                            -WI, X, 2, SCALE, XNORM, IERR )
*
*                    Scale if necessary
