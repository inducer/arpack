...
*     .. External Functions ..
      ...
      EXTERNAL           AR_LSAME, ICAMAX, SCASUM, AR_SLAMCH
*     ..
*     .. External Subroutines ..
      EXTERNAL           CCOPY, CGEMV, AR_CLATRS, CSSCAL, AR_SLABAD, AR_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
            IF( KI.GT.1 ) THEN
               CALL AR_CLATRS( 'Upper', 'No transpose', 'Non-unit', 'Y',
...
*
            IF( KI.LT.N ) THEN
               CALL AR_CLATRS( 'Upper', 'Conjugate transpose', 'Non-unit',
