...
*     .. External Functions ..
      LOGICAL            AR_LSAME
      INTEGER            IDAMAX
      DOUBLE PRECISION   DDOT, AR_DLAMCH
      EXTERNAL           AR_LSAME, IDAMAX, DDOT, AR_DLAMCH
*     ..
*     .. External Subroutines ..
      EXTERNAL           DAXPY, DCOPY, DGEMV, AR_DLABAD, AR_DLALN2, DSCAL,
     $                   AR_XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
      BOTHV = AR_LSAME( SIDE, 'B' )
      RIGHTV = AR_LSAME( SIDE, 'R' ) .OR. BOTHV
      LEFTV = AR_LSAME( SIDE, 'L' ) .OR. BOTHV
*
      ALLV = AR_LSAME( HOWMNY, 'A' )
      OVER = AR_LSAME( HOWMNY, 'B' ) .OR. AR_LSAME( HOWMNY, 'O' )
      SOMEV = AR_LSAME( HOWMNY, 'S' )
*
      INFO = 0
...
*
                     CALL AR_DLALN2( .FALSE., 1, 1, SMIN, ONE, T( J, J ),
...
*
                     CALL AR_DLALN2( .FALSE., 2, 1, SMIN, ONE,
...
*                    1-by-1 diagonal block
*
                     CALL AR_DLALN2( .FALSE., 1, 2, SMIN, ONE, T( J, J ),
...
*                    2-by-2 diagonal block
*
                     CALL AR_DLALN2( .FALSE., 2, 2, SMIN, ONE,
     $                            T( J-1, J-1 ), LDT, ONE, ONE,
...
*
                     CALL AR_DLALN2( .TRUE., 2, 1, SMIN, ONE, T( J, J ),
     $                            LDT, ONE, ONE, WORK( J+N ), N, WR,
     $                            ZERO, X, 2, SCALE, XNORM, IERR )
*
*                    Scale if necessary
...
*                      ([T(j+1,j) T(j+1,j+1)]             )
*
                     CALL AR_DLALN2( .TRUE., 2, 2, SMIN, ONE, T( J, J ),
     $                            LDT, ONE, ONE, WORK( J+N ), N, WR,
     $                            -WI, X, 2, SCALE, XNORM, IERR )
*
*                    Scale if necessary
