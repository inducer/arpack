...
*     ..
*     .. External Functions ..
      REAL               AR_CLANHS, AR_SLAMCH
      COMPLEX            AR_CLADIV
      EXTERNAL           AR_CLANHS, AR_SLAMCH, AR_CLADIV
*     ..
*     .. External Subroutines ..
      EXTERNAL           CCOPY, AR_CLARFG, CSCAL
*     ..
*     .. Intrinsic Functions ..
...
*
      ...
      SMLNUM = AR_SLAMCH( 'Safe minimum' ) / ULP
*
...
*
         DO 20 K = I, L + 1, -1
            ...
            IF( TST1.EQ.RZERO )
     $         TST1 = AR_CLANHS( '1', I-L+1, H( L, L ), LDH, RWORK )
...
*           submatrix.
*
*           V(2) is always real before the call to AR_CLARFG, and hence
*           after the call T2 ( = T1*V(2) ) is also real.
*
            IF( K.GT.M )
     $         CALL CCOPY( 2, H( K, K-1 ), 1, V, 1 )
            CALL AR_CLARFG( 2, V( 1 ), V( 2 ), 1, T1 )
            IF( K.GT.M ) THEN
               H( K, K-1 ) = V( 1 )
               H( K+1, K-1 ) = ZERO
            END IF
