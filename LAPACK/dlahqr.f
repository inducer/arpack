      SUBROUTINE AR_DLAHQR( WANTT, WANTZ, N, ILO, IHI, H, LDH, WR, WI,
...
*  =======
*
*  AR_DLAHQR is an auxiliary routine called by DHSEQR to update the
...
*          ILO = 1). AR_DLAHQR works primarily with the Hessenberg
...
*  INFO    (output) INTEGER
*          = 0: successful exit
*          > 0: AR_DLAHQR failed to compute all the eigenvalues ILO to IHI
...
*     ..
*     .. External Functions ..
      DOUBLE PRECISION   AR_DLAMCH, AR_DLANHS
