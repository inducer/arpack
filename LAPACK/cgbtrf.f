      SUBROUTINE AR_CGBTRF( M, N, KL, KU, AB, LDAB, IPIV, INFO )
*
...
*  =======
*
*  AR_CGBTRF computes an LU factorization of a complex m-by-n band matrix A
...
*     ..
*     .. External Functions ..
      INTEGER            ICAMAX, AR_ILAENV
      EXTERNAL           ICAMAX, AR_ILAENV
*     ..
*     .. External Subroutines ..
      EXTERNAL           CCOPY, AR_CGBTF2, CGEMM, CGERU, AR_CLASWP, CSCAL,
     $                   CSWAP, CTRSM, AR_XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN
*     ..
...
*
      NB = AR_ILAENV( 1, 'AR_CGBTRF', ' ', M, N, KL, KU )
*
...
*        Use unblocked code
*
         CALL AR_CGBTF2( M, N, KL, KU, AB, LDAB, IPIV, INFO )
      ELSE
*
*        Use blocked code
*
...
*
               ...
               J3 = MAX( 0, JU-J-KV+1 )
*
*              Use AR_CLASWP to apply the row interchanges to A12, A22, and
*              A32.
*
               CALL AR_CLASWP( J2, AB( KV+1-JB, J+JB ), LDAB-1, 1, JB,
     $                      IPIV( J ), 1 )
*
